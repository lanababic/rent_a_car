...
public class KreiranjeModelaVozilaForma extends JDialog {

	private static final long serialVersionUID = 1L;
	private JTextField txtNaziv, txtProizvodjac;
	private JComboBox<KategorijaVozila> cbKategorija;

	public KreiranjeModelaVozilaForma(VoziloMenadzer voziloMenadzer) {
		setTitle("Dodavanje Novog Modela Vozila");
		setModal(true);
		setBounds(100, 100, 400, 280);
		getContentPane().setLayout(null);
		setLocationRelativeTo(null);

		JLabel lblNaslov = new JLabel("Unos podataka za model vozila");
		...
		btnSacuvaj.addActionListener(e -> {
			...
			voziloMenadzer.dodajNoviModelVozila(kat, naziv, proizvodjac);
			JOptionPane.showMessageDialog(this, "Model vozila je uspešno dodat!");
			dispose();
		});
