...
public class RegistracijaKlijentaForma extends JDialog {
	...
	public RegistracijaKlijentaForma(OsobaMenadzer osobaMenadzer) {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ime.isEmpty() || prezime.isEmpty() || email.isEmpty() || lozinka.isEmpty()) {
						JOptionPane.showMessageDialog(RegistracijaKlijentaForma.this, "Sva obavezna polja moraju biti popunjena!", "Greška", JOptionPane.WARNING_MESSAGE);
						return;
					}

					if (osobaMenadzer.korisnickoImePostoji(email)) {
						JOptionPane.showMessageDialog(RegistracijaKlijentaForma.this, "Klijent sa tim Email-om već postoji!", "Greška", JOptionPane.ERROR_MESSAGE);
						return;
					}
					...
					JOptionPane.showMessageDialog(RegistracijaKlijentaForma.this, "Klijent uspešno registrovan i upisan u CSV!");
					dispose();

				} catch (DateTimeParseException ex) {
					JOptionPane.showMessageDialog(RegistracijaKlijentaForma.this, "Datumi moraju biti u formatu YYYY-MM-DD!", "Greška", JOptionPane.ERROR_MESSAGE);
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(RegistracijaKlijentaForma.this, "Broj kašnjenja mora biti numerička vrednost!", "Greška", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
