...
public class NovaPretplataForma extends JDialog {

	private static final long serialVersionUID = 1L;
	private JTextField txtKorisnickoIme;

	public NovaPretplataForma(FinansijeMenadzer finansijeMenadzer, OsobaMenadzer osobaMenadzer) {
		...
		btnKreiraj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (korIme.isEmpty()) {
					JOptionPane.showMessageDialog(NovaPretplataForma.this, 
